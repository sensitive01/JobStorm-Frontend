          ...
          <div className="col-lg-6">
            <div className="section-title me-lg-5">
              ...
              <h2 className="title mb-4">
                Why <span className="text-warning fw-bold">35,000+</span> People
                Trust On Jobcy?
              </h2>
              <p className="text-muted">
                Start working with Jobcy that can provide everything you need to
                generate awareness, drive traffic, connect. Dummy text is text
                that is used in the publishing industry or by web designers to
                occupy the space which will later be filled with 'real' content.
              </p>
          ...
          <div className="col-lg-5">
            <div className="section-title mb-5 mb-lg-0">
              ...
              <p className="text-muted">
                ...
                non magna tempor congue natuasre the whole its beauty you
              ...
              <div className="d-flex align-items-center justify-content-between mt-4">
                <div>
                  ...
                  >
                    Learn More <i className="uil uil-angle-right-b ms-1" />
                  </a>
                </div>
              ...
              <div className="col-md-9">
                ...
                >
                  <div
                    ...
                    style={{
                      backgroundImage: 'url("assets/images/about/img-02.jpg")'
                    }}
                  ></div>
                  <div
                    ...
                    style={{
                      backgroundImage: 'url("assets/images/about/img-03.jpg")'
                    }}
                  />
                  <div
                    className="tab-pane fade rounded-3"
                    ...
                    style={{
                      backgroundImage: 'url("assets/images/about/img-04.jpg")'
                    }}
                  />
                  <div
                    className="tab-pane fade rounded-3"
                    ...
                    style={{
                      backgroundImage: 'url("assets/images/about/img-05.jpg")'
                    }}
                  />
                </div>
              </div>
