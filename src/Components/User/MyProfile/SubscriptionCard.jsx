...
import { getSubscriptionCardData } from "../../../api/service/axiosService";
    ...
    const fetchCardData = async () => {
      try {
        ...
        if (response?.data?.success) {
          const { employee, isSubscribed } = response.data;
          // If we have subscription data nested in employee
          const subData = employee?.subscription;

          if (subData) {
            setCardData({
              ...subData,
              fullCardNumber: subData.cardNumber,
              cardHolderName:
                employee.userName || employee.name || "JobStorm Member", // Fallback since name isn't in subscription object
            });
        ...
        <div style={styles.cardDetailsGrid}>
          <div style={styles.detailItem}>
            ...
            <div style={styles.cardNumberRow}>
              ...
              <button style={styles.viewButton} onClick={toggleCardNumber}>
