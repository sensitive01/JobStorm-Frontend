                ...
                <div className="row">
                  <div className="col-lg-9">
                    <div className="me-lg-5">
                        ...
                        <ul className="list-inline">
                          <li className="list-inline-item">
                            <div className="popular-box d-flex align-items-center">
                              ...
                              >
                                <h6 className="fs-14 mb-0">UI/UX designer</h6>
                              </a>
                            </div>
                          </li>
                          <li className="list-inline-item">
                            <div className="popular-box d-flex align-items-center">
                              ...
                              <a
                                ...
                                className="primary-link stretched-link"
                              >
                                <h6 className="fs-14 mb-0">HR manager</h6>
                              </a>
                            </div>
                          </li>
                          <li className="list-inline-item">
                            <div className="popular-box d-flex align-items-center">
                              ...
                              <a
                                ...
                                className="primary-link stretched-link"
                              >
                                <h6 className="fs-14 mb-0">Product manager</h6>
                              </a>
                            </div>
                          </li>
                          <li className="list-inline-item">
                            <div className="popular-box d-flex align-items-center">
                              ...
                              <a
                                ...
                                className="primary-link stretched-link"
                              >
                                <h6 className="fs-14 mb-0">Sales manager</h6>
                              </a>
                            </div>
                          </li>
                          <li className="list-inline-item">
                            <div className="popular-box d-flex align-items-center">
                              ...
                              <a
                                ...
                                className="primary-link stretched-link"
                              >
                                <h6 className="fs-14 mb-0">Developer</h6>
                              </a>
                            </div>
                          </li>
                        </ul>
                      ...
                      {/* Job-list */}
                      <div>
                        <div className="job-box bookmark-post card mt-5">
                          <div className="p-4">
                            <div className="row">
                            ...
                            <div className="row">
                              ...
                              <div className="col-lg-10">
                                <div className="mt-3 mt-lg-0">
                                  ...
                                  <div className="mt-2">
                                    <span className="badge bg-danger-subtle text-danger -bg-subtle mt-1">
                                      Part Time
                                    </span>
                                    <span className="badge bg-info-subtle text-info  mt-1">
                                      Private
                                ...
                                <div className="mb-3">
                                  <form className="position-relative">
                                    ...
                                    <button
                                      ...
                                      type="submit"
                                    >
                                      <span className="mdi mdi-magnify text-muted" />
                                    </button>
                                  </form>
                                </div>
